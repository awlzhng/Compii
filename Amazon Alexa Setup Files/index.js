/**
 * Derived from Amazon Alexa Skills Kit sample skill
 * Implemented on AWS Lambda Function with "alexa-skill-kit-sdk-factskill" blueprint
 * Modified by: Y. B. Lee; Sept. 2018
 *
 * The sample demonstrates a simple skill built with the Amazon Alexa Skills Kit.
...
// Questions
const nodes = [{ "node": 1, "message": "Okay, let’s get started. . . How are you feeling?", "yes": 2, "no": 1 },
             { "node": 2, "message": "Could you rate your level of stress today on a scale from 1 to 10?", "yes": 3, "no": 2 },
             { "node": 3, "message": "How about how positive you felt today on a scale of 1 to 10?", "yes": 4, "no": 3 },
             { "node": 4, "message": "Would you like to talk about why you felt that way today?", "yes": 5, "no": 6 },
             { "node": 5, "message": "Okay . . . . . ?", "yes": 7, "no": 7 },
             { "node": 6, "message": "Okay. Would you like to practice your wellness strategies this session?", "yes": 16, "no": 8 },
             { "node": 7, "message": "Thank you for sharing your experience. Would you like to practice your wellness strategies this session?", "yes": 16, "no": 8 },
             { "node": 16, "message": "Okay. Would you like to do guided meditation, do a grounding exercise, call a friend or family member, or find resources?", "yes": 9, "no": 8 },

// TODO: Replace this data with your own.
// Answers & descriptions
             { "node": 8, "message": "Okay. Thank you for checking in.", "yes": 0, "no": 0, "description": "Have a good day." },
             { "node": 9, "message": "Great. We will have someone to help guide you through the exercises. Thank you for checking in.", "yes": 0, "no": 0, "description": "Have a good day."},
...
const welcomeMessage = "Hello, are you ready for your check-in?";

// This is the message that is repeated if the response to the initial welcome message is not heard
const repeatWelcomeMessage = "Are you ready for your check-in?";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
const promptToStartMessage = "Sorry, could you repeat that?";

// This is the prompt during the game when Alexa doesnt hear or understand a yes / no reply
const promptToSayYesNo = "Sorry, could you repeat that?";

// This is the response to the user after the final question when Alex decides on what group choice the user should be given
const decisionMessage = "That's it for this session.";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
const playAgainMessage = "Start again?";

// this is the help message during the setup at the beginning of the game
const helpMessage = "Enter setup help message here";

// This is the goodbye message when the user has asked to quit the game
const goodbyeMessage = "Okay. Thank you. Have a good day.";
...
const askQuestionHandlers = Alexa.CreateStateHandler(states.ASKMODE, {
    ...
    'OneToTenIntent': function () {
        // Handle 1 to 10 intent.
        helper.yesOrNo(this,'yes');
        this.emit(':responseReady');
    },
    'HowIntent': function () {
        // Handle Howareyou intent.
        helper.yesOrNo(this,'yes');
        this.emit(':responseReady');
    },
    'AMAZON.YesIntent': function () {
